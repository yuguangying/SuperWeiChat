...
public class EaseContactListFragment extends EaseBaseFragment {
    ...
    protected UserAvatar toBeProcessUser;
    ...
    protected void getContactList() {
        ...
        synchronized (this.contactsMap) {
            Iterator<Entry<String, UserAvatar>> iterator = contactsMap.entrySet().iterator();
            ...
            while (iterator.hasNext()) {
                ...
                if (!entry.getKey().equals("item_new_friends")
                    ...
                    if(!blackList.contains(entry.getKey())){
                        ...
                        UserAvatar user = entry.getValue();
     ...
     * @param contactsMap
     */
    public void setContactsMap(Map<String, UserAvatar> contactsMap){
    ...
    public interface EaseContactListItemClickListener {
         ...
         */
        void onListItemClicked(UserAvatar user);
    }
