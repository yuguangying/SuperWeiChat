...
//			holder.name.setText("我是"+msg.getFrom());
            Dao.findUser(context, msg.getFrom(), new OkHttpUtils.OnCompleteListener<Resultbean>() {
                @Override
                public void onSuccess(Resultbean result) {
                    if (result.isRetMsg()) {
                        ...
                        EaseUserUtils.setAppUserNick(userAvatar.getMUserName(), holder.name);
                        EaseUserUtils.setAppUserAvatar(context, userAvatar.getMUserName(), holder.avator);
                    }
                }
