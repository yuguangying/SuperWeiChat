...
public class NewGroupActivity extends BaseActivity {
    ...
    private static final int REQUESTCODE_FOR_MEMBER = 3;
    ...
    private void setListener() {
        ...
        groupsAvatar.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void initView() {
        ...
        groupsAvatar = (ImageView) findViewById(R.id.three_avatar_iv);
    }
    ...
    public void save(View v) {
        ...
        if (TextUtils.isEmpty(name)) {
            ...
            startActivityForResult(new Intent(this, GroupPickContactsActivity.class).putExtra("groupName", name), REQUESTCODE_FOR_MEMBER);
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, final Intent data) {
        ...
        switch (requestCode) {
            case REQUESTCODE_CUTTING:
                ...
                break;
            case REQUESTCODE_FOR_MEMBER:
                if (resultCode == RESULT_OK) {
                    creatEMgroup(data, st1, st2);
                }
                break;
    ...
    private void creatEMgroup(final Intent data, String st1, final String st2) {
        //new group
    ...
    private void setPicToView(Intent picdata) {
        ...
        if (extras != null) {
            ...
            groupsAvatar.setImageDrawable(drawable);
    ...
    public void savebitmapFile(Intent picdata) {
        ...
        if (extras != null) {
            ...
            String imagePath = EaseImageUtils.getImagePath(System.currentTimeMillis() + ".jpg");
